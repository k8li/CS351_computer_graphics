...
//
var VSHADER_SOURCE =              /// global variables with strings of code for GLSL
  'attribute vec4 a_Position;\n' +    /// gets run for every vertex
  'void main() {\n' +
...
var FSHADER_SOURCE =            /// gets run for every pixel!
  'void main() {\n' +
...
//==============================================================================
  ...
  /// canonical view volume = limits of the screen that you can draw in.
...
// first, create an array with all our vertex attribute values:
  var vertices = new Float32Array([
     0.5,  0.5, -0.5, 1.0,	// CAREFUL! I made these into 4D points/ vertices: x,y,z,w.
    -0.5,  0.5, -0.5, 1.0,	// new point!  (? What happens if I make w=0 instead of 1.0?)
    -0.5, -0.5, -0.5, 1.0,   
     0.5, -0.5, -0.5, 1.0, 	// new point!
     0.5,  0.5, 0.5, 1.0,	
    -0.5,  0.5, 0.5, 1.0,	
    -0.5, -0.5, 0.5, 1.0,   
     0.5, -0.5, 0.5, 1.0, 	// new point!
